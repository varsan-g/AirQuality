                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      ...
                                      options: SensorGroup.listAllSensorsCall
                                          .roomName(
                                        listViewListAllSensorsResponse.jsonBody,
                                      )!,
                                      onChanged: (val) async {
                                        setState(() => _model
                                        ...
                                        if ((_model.apiCallResult?.succeeded ??
                                            true)) {
                                          setState(() {});
                                        }
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child:
                                                                  ...
                                                                  FFLineChartData(
                                                                    xData:
                                                                      ...
                                                                      rowFilterDataByHoursResponse
                                                                          .jsonBody,
                                                                      r'''$.sensors[?(@.roomName=='Blå stue')].timestamps''',
                                                                    ),
                                                                    yData:
                                                                        getJsonField(
                                                                      rowFilterDataByHoursResponse
                                                                          .jsonBody,
                                                                      r'''$.sensors[?(@.roomName=='Blå stue')].co2''',
                                                                    ),
                                                                    settings:
                                                                        LineChartBarData(
                                                                      color: const Color(
                                                                ...
                                                                xAxisLabelInfo:
                                                                    AxisLabelInfo(
                                                                  title:
                                                                      '${_model.dayDropDownValue} time(r)',
                                                                  titleTextStyle:
                                                                      const TextStyle(
                                                                    fontSize:
                                                                        14.0,
                                                              ...
                                                              data: [
                                                                FFLineChartData(
                                                                  ...
                                                                  yData:
                                                                    ...
                                                                    rowFilterDataByHoursResponse
                                                                        .jsonBody,
                                                                    r'''$.sensors[?(@.roomName=='Blå stue')].temperatures''',
                                                                  ),
                                                                  settings:
                                                                      LineChartBarData(
                                                                    color: const Color(
                                                              ...
                                                              data: [
                                                                FFLineChartData(
                                                                  ...
                                                                  yData:
                                                                    ...
                                                                    rowFilterDataByHoursResponse
                                                                        .jsonBody,
                                                                    r'''$.sensors[?(@.roomName=='Blå stue')].humidities''',
                                                                  ),
                                                                  settings:
                                                                      LineChartBarData(
                                                                    color: const Color(
