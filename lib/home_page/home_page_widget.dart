...
import '/components/active_sensor_widget.dart';
...
class _HomePageWidgetState extends State<HomePageWidget>
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      future: SensorGroup.getAllSensorDataCall.call(
      ...
      builder: (context, snapshot) {
        ...
        final homePageGetAllSensorDataResponse = snapshot.data!;
                            ...
                            children: [
                              FutureBuilder<ApiCallResponse>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final rowGetSensorDataFromSpecificRoomNameResponse =
                                      snapshot.data!;
                                  return Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: [
                                                ...
                                                children: [
                                                  ...
                                                  Align(
                                                    ...
                                                    child: FlutterFlowDropDown<
                                                      ...
                                                      options: SensorGroup
                                                          .getAllSensorDataCall
                                                          .roomNames(
                                                        homePageGetAllSensorDataResponse
                                                            .jsonBody,
                                                      )!,
                                                      onChanged: (val) =>
                                                          setState(() => _model
                                                            ...
                                                            padding:
                                                                const EdgeInsetsDirectional
                                                                    .fromSTEB(
                                                                        ...
                                                                        12.0),
                                                            child: Text(
                                                              'Et overblik over antallet af sensorer.',
                                                              textAlign:
                                                                  TextAlign
                                                                      .start,
                                                              style: FlutterFlowTheme
                                                                  ...
                                                                  child: Text(
                                                                    valueOrDefault<
                                                                      ...
                                                                      SensorGroup
                                                                          .getAllSensorDataCall
                                                                          .sensorObj(
                                                                            homePageGetAllSensorDataResponse.jsonBody,
                                                                          )
                                                                          ?.length
                                                                          .toString(),
                                                                      'N/A',
                                              ...
                                              Padding(
                                                padding: const EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 0.0, 0.0, 12.0),
                                                child: Text(
                                                  'Et overblik over sensorer, der har registret dårligt indeklima.',
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              ...
                                              return ReorderableListView
                                                ...
                                                itemBuilder:
                                                    (context, sensorListIndex) {
                                                  final sensorListItem =
                                                      sensorList[
                                                          sensorListIndex];
                                                  return Container(
                                                    key: ValueKey(
                                                    ...
                                                    child: ActiveSensorWidget(
                                                      key: Key(
                                                          'Keynoo_${sensorListIndex}_of_${sensorList.length}'),
