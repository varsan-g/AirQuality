...
class CO2Sensor(adafruit_scd4x.SCD4X): # CO2Sensor inherits the SCD4X class from the adafruit_scd4x module.
    # Constructor method (self is a keyword)
    def __init__(self, ID = None, yellow_threshold = 800, red_threshold = 1000, timeout = 10): # The values after '=' are default values when nothing is passed.
        i2c = board.I2C()
    ...
    def measure(self):
        ...
        self.start_periodic_measurement() # Initiate continuous measurement mode. Remember to stop it later with stop_periodic_measurement()
...
if __name__ == '__main__': # This is useful when you want to import the module in another file without running the code automatically.
    try:
        main()
